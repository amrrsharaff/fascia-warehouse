A classroom-based project which is essentially a system for a warehouse which receives a list of orders of Fascia for cars and it produces the fascia accordingly.
